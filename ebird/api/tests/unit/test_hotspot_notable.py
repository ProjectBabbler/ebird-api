...
from ebird.api.data import HOTSPOT_NOTABLE_URL, hotspot_notable
...
class HotspotNotableTests(TestCase):
    ...
    def test_url(self, mocked_function):
        ...
        hotspot_notable('L12345')
        actual = mocked_function.call_args[0][0]
        self.assertEqual(HOTSPOT_NOTABLE_URL, actual)
