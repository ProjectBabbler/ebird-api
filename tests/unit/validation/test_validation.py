...
class ValidationTests(unittest.TestCase):
    ...
    def test_is_country(self):
        self.assertTrue(validation.is_country('US'))

    def test_incomplete_country(self):
        self.assertFalse(validation.is_country('U'))
    ...
    def test_lat_string(self):
        ...
        self.assertEqual('45.34', validation.clean_lat('45.34'))

    def test_lat_max(self):
        """If the latitude is greater than 90 then an exception is raised."""
        self.assertRaises(ValueError, validation.clean_lat, 90.01)
