...
from ebird.api.data import HOTSPOT_SPECIES_URL, hotspot_species
...
class HotspotSpeciesTests(TestCase):
    ...
    def test_url(self, mocked_function):
        ...
        hotspot_species('Apus apus', 'L12345')
        actual = mocked_function.call_args[0][0]
        self.assertEqual(HOTSPOT_SPECIES_URL, actual)
